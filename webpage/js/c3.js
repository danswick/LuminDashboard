(function (window) {
    ...
    c3_chart_internal_fn.initParams = function () {
        ...
        $$.color = $$.generateColor();
        $$.labelColor=config.data_color_label;
    ...
    c3_chart_internal_fn.updateAndRedraw = function (options) {
        ...
        options = options || {};
        // same with redraw
        options.withTransition = getOption(options, "withTransition", false);
    ...
    c3_chart_internal_fn.isWithinBar = function (_this) {
        var d3 = this.d3,
            ...
            // console.log( _this);
            // console.log( d3.touch(_this));
            // console.log( d3.mouse(_this));
