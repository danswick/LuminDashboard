...
// Adding forecast.js
var billSoFarValue = 70;
var billForecastValue = 135;
...
console.log();
$("#forecastMonthLabel").text("This Month: $"+ (dashboardData.savingsGoal));

$("#forecastSoFarLabelValue").text(" $" + getBillSofar(date.getDay()));
$("#forecastTotalLabelValue").text("  $" + (dashboardData.savingsGoal - getBillSofar(date.getDay())));
$("#forecastProgressBar").css('width', getBillSofar(date.getDay()) / dashboardData.savingsGoal * 100 + '%').attr('aria-valuenow', getBillSofar(date.getDay()) / dashboardData.savingsGoal * 100);
...
// Close showInfo callback function	
}
